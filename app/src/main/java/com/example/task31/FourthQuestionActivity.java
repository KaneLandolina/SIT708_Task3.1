...
public class FourthQuestionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //update progress bar to 80% filled
        ...
        nameTitleTextView.setText("Almost There " + nameValue + "! Fourth question!");
        ...
        submitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (selectedAnswer == null) {
                    Toast.makeText(FourthQuestionActivity.this, "Please select an answer.", Toast.LENGTH_SHORT).show();
                } else {
                    submitClicked++;
                }
                if (submitClicked == 1) {
                    scoreTally = functions.submitClicked(selectedAnswer, 4, scoreTally, answer1Button, answer2Button,answer3Button,answer4Button);
                    submitButton.setText("Next Question");
                } else if (submitClicked == 2) {
                    Log.v("check twice", scoreTally.toString());
                    Intent newIntent = new Intent(FourthQuestionActivity.this, FifthQuestionActivity.class);
